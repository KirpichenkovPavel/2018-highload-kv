...
public class KVDaoImpl implements KVDao {
    ...
    /**
     * Convert key from byte array to file path
     * The total number of subdirectories and files in one directory is limited
     * Long keys are transformed into directory hierarchy
     */
    @NotNull
